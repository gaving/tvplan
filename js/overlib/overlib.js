...
////////
var olLoaded=0, pmStart=10000000, pmUpper=10001000, pmCount=pmStart+1, pms=new Array(), pmt='', olInfo=new Info('4.17', 0);
...
function placeLayer() {
	var placeX,placeY,iwidth=iheight=widthFix=0;
...
function createDivContainer(id,frm,zVal) {
	...
	if (divContainer==null) {
		...
		with (objRef) {
			...
			visibility='hidden';
			zIndex=zVal;
			left = top = ((olIe4&&!olOp) ? 0 : -10000) + (!olNs4 ? 'px' : 0);
		}
	}
	return divContainer;
}
